...
public class PokerTypeTest {
  ...
  @Test
  void should_return_straight_when_verify_poker_type_given_3D_4S_5H_6D_7C() {
    //given
    String[] poker = {"3D", "4S", "5H", "6D", "7C"};
  ...
  @Test
  void should_return_straight_flush_when_verify_poker_type_given_3D_4D_5D_6D_7D() {
    //given
